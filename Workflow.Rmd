...
subtitle: A Robust workflow for software driven data analysis
---
...
DiagrammeR::mermaid("
    ...
    ")
# To style active cell --- style 0 fill:#fb4934,stroke:#000000,stroke-width:2px
# Class definition --- classDef className fill:#fabd2f,stroke:#000000,stroke-width:2px
# Assign class to node --- class 4 className
```
...
```{r TODO_Item_Management, eval=FALSE}
...
```{r Bibliography_Creation, eval=FALSE}
...
```{r Diagram_CleanCode, echo=FALSE}
DiagrammeR::mermaid("
    graph TB
      style 0 fill:#fb4934,stroke:#000000,stroke-width:2px
